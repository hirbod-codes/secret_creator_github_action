...
declare module "http" {
     ...
     * @since v22.5.0
     */
    const WebSocket: import("node_moduless/undici-types").WebSocket;
    /**
     * @since v22.5.0
     */
    const CloseEvent: import("node_moduless/undici-types").CloseEvent;
    /**
     * @since v22.5.0
     */
    const MessageEvent: import("node_moduless/undici-types").MessageEvent;
}
